...
- Pages-ready demo assets: present
- agent-ready JSON surface: present
- external third-party adoption proof: still needed
...
## Priority domains for external stories

1. clinical / irregular monitoring
2. energy / operations
3. product analytics / launch analysis
...
Start from [USER_STORY_TEMPLATE.md](USER_STORY_TEMPLATE.md).
