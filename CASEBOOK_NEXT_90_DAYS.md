...
This casebook focuses on examples that are easy to explain publicly and likely to attract attention over the next three months.

## 1. OpenClaw star growth and star velocity

Why it works:
- people instantly understand GitHub stars
...
- a similarity summary that says whether the current burst resembles a sustainable climb or a short spike
- a narrative report that says whether the match comes from trend, rhythm, timing shift, or burstiness

## 2. BTC vs gold vs oil

Why it works:
- the trio lets you tell a macro story quickly
...
## 3. Launch traffic vs signup conversion

Why it works:
- founders, product teams, and growth operators immediately understand the metrics
...
## 4. Longitudinal wearable cohort

Why it works:
- it still demonstrates serious scientific value
